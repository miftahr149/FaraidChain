...
public class WasiatRegistryDeployer {
  ...
  public static void main(String[] args) throws Exception {
    ...
    RemoteCall<WasiatRegistry> remoteCall = WasiatRegistry.deployRemoteCall(WasiatRegistry.class,
        web3j, credentials, new DefaultGasProvider(), WasiatRegistry.BINARY, "");
    WasiatRegistry contract = remoteCall.send();
