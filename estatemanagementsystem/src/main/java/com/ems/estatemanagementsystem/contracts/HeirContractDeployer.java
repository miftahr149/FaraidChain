...
public class HeirContractDeployer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RemoteCall<Heir_sol_WasiatDetails> remoteCall =
                Wasiat.deployRemoteCall(Heir_sol_WasiatDetails.class, web3j, credentials,
                        new DefaultGasProvider(), Heir_sol_WasiatDetails.BINARY, "");
        Heir_sol_WasiatDetails contract = remoteCall.send();
